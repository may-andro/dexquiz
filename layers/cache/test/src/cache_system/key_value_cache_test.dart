...
class TestCache extends KeyValueCache<String> {
  TestCache(final SharedPreferences sharedPreferences)
      : super(sharedPreferences, 'test_cache');
...
void main() {
  group(KeyValueCache, () {
    ...
    setUp(() {
      ...
      keyValueCache = TestCache(mockedSharedPreferences);
    });
    group('get', () {
