...
extension DSThemeExtension on DSTheme {
  ...
  ColorScheme get colorScheme {
    return ColorScheme.fromSeed(
      ...
      surfaceVariant: colorPalette.background.surfaceVariant.color,
      ...
      background: colorPalette.background.primary.color,
      onBackground: colorPalette.background.onPrimary.color,
